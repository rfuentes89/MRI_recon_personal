function data = motion_correction_non_rigid(data, motion_curves, csm)
    ...
    for repetition = 1:n_repetitions
        for set = 1:n_sets
            for echo = 1:n_echoes
                ...
                bin_limits_cell{echo,set,repetition} = hard_bin_limits(fh_motion_cell{echo,set,repetition}(included), n_bins);
                ...
                [data.k_spaces_corrected{echo,set,repetition},At_bins{echo,set,repetition}] = Focus_binsV2(data.k_spaces{echo,set,repetition},data.segment_masks{echo,set,repetition},motion,bin_limits_cell{echo,set,repetition});
                ...
                data.displacement_fields{echo,set,repetition} = register_bins(weighted_k_spaces_cell{echo,set,repetition}, weighted_sampling_masks_cell{echo,set,repetition}, csm);
            end
        end
    end
