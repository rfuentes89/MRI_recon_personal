function [fh_displacements, rl_displacements] = register_navigators_CM(navigators)
        ...
        for set = 1:n_sets
            ...
            parfor navigator = 1:n_navigators
                for echo = 1:n_echoes
                    ...
                    fh_displacements(echo,set,navigator,repetition) = -tform.T(3,2);  % Camila Change
