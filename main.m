...
csm = get_csm(data.k_spaces, CONFIG.coil_params.csm_algorithm, CONFIG.selected_contrasts_for_rating, CONFIG.coil_params.csm_params);
...
function displacement_fields = load_or_calculate_dfs(data, config)
    if strlength(config.motion_correction_params.load_disp_fields) > 0
        ...
        displacement_fields = calculate_disp_fields( ...
            ...
            config.motion_correction_params.divide_dfs_by_resolution);
