...
plt.savefig('my_denoising_60ms.png', bbox_inches='tight')
...
plt.close(1)
plt.figure(2)
plt.imshow(np.abs(denoised_image_BrB_Ax_60[:, :, 39]), cmap="gray")
plt.savefig('my_BrB_Ax_60ms.png', bbox_inches='tight')
plt.close(2)
plt.figure(3)
plt.imshow(np.abs(denoised_image_BB_Cor_60[:, :, 39]), cmap="gray")
plt.savefig('my_BB_Cor_60ms.png', bbox_inches='tight')
plt.close(3)
plt.figure(4)
plt.imshow(np.abs(denoised_image_BrB_Cor_60[:, :, 39]), cmap="gray")
