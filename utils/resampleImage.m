function new = resampleImage(old,deformationField)
% Resample an image using a deformation field
...
elseif ndims == 3
    ...
    % Current boundary condition is NaN. This means that points that leave 
    % the FOV disapear altogether.
    floorGridX(floorGridX<1)=1;
    floorGridY(floorGridY<1)=1;
